...
/// Protocol template selector dialog for Incubator
class ProtocolSelectorDialog extends ConsumerStatefulWidget {
  ...
  ConsumerState<ProtocolSelectorDialog> createState() =>
      _ProtocolSelectorDialogState();
}

class _ProtocolSelectorDialogState
    extends ConsumerState<ProtocolSelectorDialog> {
  ...
  Future<void> _loadTemplates() async {
    try {
      ...
      final templates = await repository.getProtocolTemplates();
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        template['name'] ?? 'Unnamed Protocol',
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          if (template['humidity'] != null)
                            _buildInfoChip(
                              context,
                              Icons.water_drop,
                              '${template['humidity']}%',
                            ),
                          if (template['co2'] != null)
                            _buildInfoChip(
                              context,
                              Icons.cloud,
                              '${template['co2']}%',
